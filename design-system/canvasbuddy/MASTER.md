...
|------|-----|--------------|
| Canvas Red | `#E03E26` | `--color-canvas-red` |
| Canvas Blue (links) | `#2D7DD2` | `--color-canvas-blue` |
| CTA / Brand | `#E03E26` | `--color-cta` |
| Background | `#F0F4F8` | `--color-background` |
| Nav | `#2D3B45` | `--color-nav-bg` |
| Text | `#2D3B45` | `--color-text` |

**Color Notes:** Canvas signature red for brand/buttons; blue for in-app links (matches Canvas)
